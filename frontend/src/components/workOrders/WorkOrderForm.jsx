        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
                ...
                <button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full sm:w-auto sm:flex-1 px-6 h-11 bg-vw-green hover:bg-vw-green-dark text-white rounded-md text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-vw-green disabled:opacity-50 disabled:cursor-not-allowed transition-colors relative overflow-hidden"
                >
                    {isUploading ? (
                    ...
                    {isUploading && (
                        <div
                            className="absolute bottom-0 left-0 h-1 bg-white bg-opacity-40 transition-all duration-300"
