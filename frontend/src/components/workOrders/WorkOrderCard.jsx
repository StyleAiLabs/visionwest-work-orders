                ...
                <div className="flex items-center gap-2">
                    <div className="flex items-center gap-1">
                        ...
                        {(() => {
                            ...
                            return photoCount > 0 ? (
                                <div className="flex items-center text-xs text-gray-500 bg-white px-2 py-1 rounded-full border border-gray-200">
                                ...
                                <div className="flex items-center text-xs text-gray-400 bg-white px-2 py-1 rounded-full border border-gray-200">
                                    <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
